...
| q | CONCAT_WS(separator, str1, str2 [, string ]*)  | Concatenates two or more strings, accept at least 3 arguments(at most 254), any of the null arguments is treated as empty string
